...
Throughout this semester, one of the main assignments we had to keep us on track were the submissions and revisions of a Proposal and Plan, which have been collected here in this page.
...
# Plan V2
**30th**: Proposal/Plan V2 Deadline 

### November 2025

**6th**: ~~Create timeline of events~~ Finish first set of eda

**27th**: Evalute the clearence cascade

### December 2025

**4th**: Present on clearence cascade
...
### January
* Finish analysis on Testing trends

### Febuary - April
* Publish research on clearnece cascade and testing patterns, with stakeholder as co-author.
